package develop.cl.com.crsp.config;
...
public class Constants {
	...
	// 保存参数文件夹名称
	public static final String SHARED_PREFERENCE_NAME = "itau_xnzygxpt_prefs";
	...
	// 图片存储路径
	public static final String BASE_PATH = SD_PATH + "/iTau/xnzygxpt/";
