    ...
    protected void initView() {
        ...
        switch (servicePosition) {
            ...
            case 3:
                ...
                mySetAdapter(lv_class, datalist, sadapter, typeName3, FabuFuwuDetailActivity.class);
                break;
            case 4:
                String[] typeName4 = {"校内新闻", "校内活动", "校内赛事", "校内八卦", "校内通知消息", "其他"};
                mySetAdapter(lv_class, datalist, sadapter, typeName4, FabuInfoDetailActivity.class);
                break;
            default:
                break;
        }
